...
class PersonaPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $fisModelName = 'PersonaPeticion';
    ...
    protected static $fisTypes = [
        ...
        'rfc' => 'string',
        'curp' => 'string',
        'nacionalidad' => '\FIS\MX\Client\Model\CatalogoNacionalidad',
        'residencia' => '\FIS\MX\Client\Model\CatalogoResidencia',
        'estado_civil' => '\FIS\MX\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\FIS\MX\Client\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\FIS\MX\Client\Model\DomicilioPeticion'
    ];
