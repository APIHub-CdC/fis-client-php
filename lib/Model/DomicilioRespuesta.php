...
class DomicilioRespuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $fisModelName = 'DomicilioRespuesta';
    ...
    protected static $fisTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\FIS\MX\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\FIS\MX\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\FIS\MX\Client\Model\CatalogoTipoAsentamiento',
